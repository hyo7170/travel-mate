...
import FlightCard from '../components/FlightCard'; // FlightCard 임포트
  ...
  return (
    <View style={styles.mainContainer}>
      <View style={styles.selectorContainer}>
        <SelectorButton 
          label={selectedCity ? translate(airportCode.find(city => city.id === selectedCity).name) : translate('전체 도시')}
